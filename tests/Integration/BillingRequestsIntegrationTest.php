...
class BillingRequestsIntegrationTest extends IntegrationTestBase
{
    ...
    public function testBillingRequestsCreateWithActions()
    {
        $fixture = $this->loadJsonFixture('billing_requests')->create_with_actions;
        $this->stub_request($fixture);
    ...
    public function testBillingRequestsCreateWithActionsWithIdempotencyConflict()
    {
        $fixture = $this->loadJsonFixture('billing_requests')->create_with_actions;
