...
class Paginator implements \Iterator
{
    ...
    /** @var \GoCardlessPro\ListResponse First response page (used to loop multiple times) */
    private $initial_response;

    /** @var \GoCardlessPro\ListResponse Current response page */
    ...
    /** @var \GoCardlessPro\Services\Base The parent service class to fetch records from */
    private $parent;

    /** @var \GoCardlessPro\Resources\Wrapper\NestedObject Meta information for the current page */
    private $meta;
