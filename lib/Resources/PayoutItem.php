...
class PayoutItem extends BaseResource
{
     ...
     *  payment.</li>
     *  <li>`refund_funds_returned` (credit): The refund could not be sent to
     *  the customer, and the funds have been returned to you.</li>
     *  <li>`gocardless_fee` (credit/debit): The fees that GoCardless charged
     ...
     *  failure or chargeback, these will appear as credits.</li>
